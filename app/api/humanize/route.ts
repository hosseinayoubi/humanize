...
export async function POST(req: NextRequest) {
  try {
    ...
    // Decimal-safe
    const costRaw: any = estimateCostUsd(wc) // returns string in your code :contentReference[oaicite:2]{index=2}
    const cost = new Prisma.Decimal(String(costRaw))
